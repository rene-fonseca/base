...
void IEEE1394::IsochronousRequestImpl::setOptions(unsigned int options) throw(IEEE1394Exception) {
  bassert(
    status == READY,
    IEEE1394Exception("Request not ready", this).setCause(IEEE1394::REQUEST_NOT_READY)
  );
...
void IEEE1394::IsochronousRequestImpl::reset() throw(IEEE1394Exception) {
  bassert(
    status != PENDING,
    IEEE1394Exception("Request is pending", this).setCause(IEEE1394::REQUEST_NOT_PENDING)
  );
  resetContext();
  status = READY;
}
...
void IEEE1394::IsochronousWriteRequestImpl::setBuffer(
  ...
  bassert(getStatus() == READY, IEEE1394Exception("Request not ready", this).setCause(IEEE1394::REQUEST_NOT_READY));
  this->buffer = buffer;
  this->bufferSize = size;
...
EUI64 IEEE1394::getIdentifier(unsigned short node) throw(IEEE1394Exception) {
  ...
  bassert(
    ...
    IEEE1394Exception("No general configuration ROM", this).setCause(IEEE1394::NO_GENERAL_CONFIGURATION_ROM)
  );
  uint32 name = getQuadlet(node, IEEE1394::BUS_INFO_NAME);
  bassert(
...
unsigned int IEEE1394::getMaximumPayload(unsigned short node) throw(IEEE1394Exception) {
  ...
  bassert(
    ...
    IEEE1394Exception("No general configuration ROM", this).setCause(NO_GENERAL_CONFIGURATION_ROM)
  );
  uint32 name = getQuadlet(node, IEEE1394::BUS_INFO_NAME);
  bassert(
    name == 0x31333934, // "1394"
...
unsigned int IEEE1394::getVendorId(unsigned short node) throw(IEEE1394Exception) {
  ...
  bassert(
    ...
    (name == 0x31333934), // "1394"
    IEEE1394Exception("Invalid configuration ROM", this).setCause(IEEE1394::INVALID_BUS_INFORMATION_BLOCK)
  );
