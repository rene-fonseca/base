...
public:
  ...
  */
  IEEE1394Exception(const Type& type) noexcept
    : CommunicationsException(type)
  {
  }
  ...
  /**
    ...
    @param type The identity of the type.
  */
  IEEE1394Exception(const char* message, const Type& type) noexcept
    : CommunicationsException(message, type)
  {
  }
