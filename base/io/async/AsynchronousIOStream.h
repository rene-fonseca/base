...
public:
  ...
  */
  virtual AsynchronousReadOperation read(void* buffer, unsigned int bytesToRead, unsigned long long offset, AsynchronousReadEventListener* listener) throw(AsynchronousException) = 0;
  ...
  /**
    ...
    @param offset The offset.
  */
  virtual AsynchronousWriteOperation write(const void* buffer, unsigned int bytesToWrite, unsigned long long offset, AsynchronousWriteEventListener* listener) throw(AsynchronousException) = 0;
};
