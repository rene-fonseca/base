...
public:
  ...
  */
  inline AsynchronousReadCompletion(void* _buffer, unsigned int _bytesToRead, unsigned long long _offset, unsigned int _bytesRead, unsigned int _flags) throw() 
    : buffer(_buffer),
