...
#ifndef _DK_SDU_MIP__BASE_STRING__STRING_EXCEPTION_H
#define _DK_SDU_MIP__BASE_STRING__STRING_EXCEPTION_H
...
/**
  This exception is thrown on String specific exceptions.
